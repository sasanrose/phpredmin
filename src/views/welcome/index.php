    ...
    <div class="tab-content">
        <div class="tab-pane fade active in" id="keys">
            ...
            <form class="form-search" action="<?php echo $this->router->url?>/keys/search/<?php echo $this->app->current['serverId'].'/'.$this->app->current['database'] ?>" method="get">
                ...
                or <a href="<?=$this->router->url?>/keys/search/<?= $this->app->current['serverId'] . '/' . $this->app->current['database'] ?>?key=*">Show All</a>
            </form>
        ...
        <div class="tab-pane fade" id="delete">
            <form class="form-search" id="bulkdelete">
				...
				<?php if (!extension_loaded('gearman')): ?>
					<div class="alert alert-warning">
						<a class="close" data-dismiss="alert" href="#">×</a>
						This uses gearman. You need to install <a href="http://www.php.net/manual/en/gearman.setup.php" target="_blank">gearman extionsion for PHP</a> and <a href="https://github.com/faktiva/php-redis-admin/blob/master/Features.md#gearman-worker" target="_blank">setup gearman worker</a>
					</div>
				<?php endif ?>
